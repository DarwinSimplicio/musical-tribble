...
Public Class rpt_daySummary
    ...
    Public Overrides Property FullResourceName() As String
        Get
            Return "prjBBCOC_v08262021.rpt_daySummary.rpt"
        End Get
        Set
            'Do nothing
        End Set
...
Public Class Cachedrpt_daySummary
    Inherits Component
    ...
    Public Overridable Function CreateReport() As CrystalDecisions.CrystalReports.Engine.ReportDocument Implements CrystalDecisions.ReportSource.ICachedReport.CreateReport
        Dim rpt As rpt_daySummary = New rpt_daySummary()
        rpt.Site = Me.Site
        Return rpt
    End Function
