...
Public Class rpt_members
    ...
    Public Overrides Property FullResourceName() As String
        Get
            Return "prjBBCOC_v08262021.rpt_members.rpt"
        End Get
        Set
            'Do nothing
        End Set
...
Public Class Cachedrpt_members
    Inherits Component
    ...
    Public Overridable Function CreateReport() As CrystalDecisions.CrystalReports.Engine.ReportDocument Implements CrystalDecisions.ReportSource.ICachedReport.CreateReport
        Dim rpt As rpt_members = New rpt_members()
        rpt.Site = Me.Site
        Return rpt
    End Function
