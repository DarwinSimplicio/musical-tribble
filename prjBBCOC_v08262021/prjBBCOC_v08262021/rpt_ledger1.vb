...
Public Class rpt_ledger1
    ...
    Public Overrides Property FullResourceName() As String
        Get
            Return "prjBBCOC_v08262021.rpt_ledger1.rpt"
        End Get
        Set
            'Do nothing
        End Set
...
Public Class Cachedrpt_ledger1
    Inherits Component
    ...
    Public Overridable Function CreateReport() As CrystalDecisions.CrystalReports.Engine.ReportDocument Implements CrystalDecisions.ReportSource.ICachedReport.CreateReport
        Dim rpt As rpt_ledger1 = New rpt_ledger1()
        rpt.Site = Me.Site
        Return rpt
    End Function
