...
Public Class rpt_ledger2
    ...
    Public Overrides Property FullResourceName() As String
        Get
            Return "prjBBCOC_v08262021.rpt_ledger2.rpt"
        End Get
        Set
            'Do nothing
        End Set
...
Public Class Cachedrpt_ledger2
    Inherits Component
    ...
    Public Overridable Function CreateReport() As CrystalDecisions.CrystalReports.Engine.ReportDocument Implements CrystalDecisions.ReportSource.ICachedReport.CreateReport
        Dim rpt As rpt_ledger2 = New rpt_ledger2()
        rpt.Site = Me.Site
        Return rpt
    End Function
