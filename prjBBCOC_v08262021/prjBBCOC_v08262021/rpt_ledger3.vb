...
Public Class rpt_ledger3
    ...
    Public Overrides Property FullResourceName() As String
        Get
            Return "prjBBCOC_v08262021.rpt_ledger3.rpt"
        End Get
        Set
            'Do nothing
        End Set
...
Public Class Cachedrpt_ledger3
    Inherits Component
    ...
    Public Overridable Function CreateReport() As CrystalDecisions.CrystalReports.Engine.ReportDocument Implements CrystalDecisions.ReportSource.ICachedReport.CreateReport
        Dim rpt As rpt_ledger3 = New rpt_ledger3()
        rpt.Site = Me.Site
        Return rpt
    End Function
