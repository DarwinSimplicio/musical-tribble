...
Public Class Frm_batchMain
    ...
    Private Sub btnSave_Click(sender As Object, e As EventArgs) Handles btnSave.Click
        If txtdesc.Text = String.Empty Then
            MsgBox("Batch name must not be empty.", MsgBoxStyle.Exclamation, "Add Batch")
            txtdesc.Focus()
            Exit Sub
        End If
        If addflg = 1 Then
            If Not cls._spinsert_batch(Me.txtdesc.Text) Then
        ...
        Else
            If lblIdnum.Text = String.Empty Then
                MsgBox("Select record first.", MsgBoxStyle.Exclamation, "Add Batch")
                Exit Sub
            End If
            If Not cls._spupdate_batch(lblIdnum.Text, Me.txtdesc.Text) Then
        ...
        If TypeOf e.Column Is Telerik.WinControls.UI.GridViewCommandColumn AndAlso e.RowIndex >= 0 Then
            If Not IsDBNull(Me.RadGridView1.Rows(RadGridView1.CurrentRow.Index).Cells(0).Value) Then
                ...
                If e.ColumnIndex = 2 Then
                    ...
                    Dim dt As New DataTable
                    If Not cls._spselect_batch2(idnum, dt) Then

                        Throw New Exception(cls.errMessage)
                    End If

                    If dt.Rows.Count > 0 Then
                        cdesc = IIf(IsDBNull(dt.Rows(0).Item("batcode").ToString.Trim) = True, "", dt.Rows(0).Item("batcode").ToString.Trim)
                ...
                ElseIf e.ColumnIndex = 3 Then
                    ...
                    If MsgBox("Are you sure you want to delete this record?", MsgBoxStyle.YesNo, "Delete Record") = MsgBoxResult.Yes Then
                        If Not cls._spdelete_batch(idnum) Then
